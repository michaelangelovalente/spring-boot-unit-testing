...
public class ReflectionTestUtilsTest {
    ...
    public void studentBeforeEach(){
        ...
        //setting private fields directly with ReflectionTestUtils
    ...
    public void getPrivateField(){
        assertEquals(1, ReflectionTestUtils.getField(studentOne, "id")); // accessing the private field directlty
    }
